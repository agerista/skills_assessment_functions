...
def total_meal_price(meal_price, tip=.15):
    ...
    payment_amount = (meal_price * tip) + meal_price
...
def full_title(full_name, job_title="Engineer"):

    return job_title + " " + full_name
...
def write_letter(full_name, job_title, sender_name):

    print "Dear {0}, I think you are amazing!" .format(full_title(full_name, job_title)),
    print "Sincerely, {0}" .format(sender_name)
